...
<div class="row justify-content-end">
    ...
    <button class="button" style="border-radius: 10px;"><a href="../index.php" style="text-decoration: none; color:aliceblue">Student</a></button>
    </div>
</div>
    <div class="h1 text-center mt-5">Library Admin</div>
    <div class="row justify-content-center">
        ...
        <form class="form card" action="" method="post">
                <div class="card_header">
                    ...
                    <h1 class="form_heading">Sign in for Admin</h1>
                </div>
                <div class="field">
                ...
                <div class="field">
                    <button class="button" type="submit" name="login" style="border-radius: 10px;">Login</button><br>
                </div>
                </form>
                <?php
